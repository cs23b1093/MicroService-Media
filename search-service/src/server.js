...
const { connectToRabbitMQ, consumeEvent } = require("./utils/rabitMQ");
const searchRoutes = require("./eventHandlers/search-event-handlers");
const {
  handlePostCreated,
  handlePostDeleted,
} = require("./eventHandlers/search-event-handlers");
const router = require("./routers/search.router");
